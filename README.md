### 写在前面
* 如果你想捐赠, 请联系[原插件作者(chooyy)](https://github.com/choyy)或[点击这里捐赠](https://afdian.com/a/chooyy), 而不是我
* 只适配了windows的全局搜索, 如果感觉不好用, 请换回原插件
...
2. 如果发现搜索页面有问题, 重启下思源试试, 如果还不行, 就换回原插件吧


### 在 简易搜索v0.2.2 的基础上, 具体修改内容如下
* \[bug]: 搜索历史偶尔会出现sql语句
